...
%>
<div class="rating">
	<select name="score" onchange="new Ajax.Updater('rating-${c.poem.key()}', '${h.url_for(controller="poems", action="score", id=c.poem.key())}', { parameters: { score: $F(this)}}); $('rating'-${c.poem.key()}).toggle()">
